...
model_best = load_model('best_model_101class.h5')
...
def index():
    ...
    return render_template('home_new.html', img=img)
...
def upload():
    ...
    for f in file:
        ...
        num[0] += 1
        name = os.path.join(app.config['uploads'], filename)
